...
const CounDown = () => {
  ...
  // Updated deadline (end of year sale)
        ...
        <div className="relative overflow-hidden z-1 rounded-lg bg-[#D0E9F3] p-4 sm:p-7.5 lg:p-10 xl:p-15">
          <div className="max-w-[422px] w-full">
            ...
            <h2 className="font-bold text-dark text-xl lg:text-heading-4 xl:text-heading-3 mb-3">
              Elevate Your Pilot Wardrobe
            </h2>

            <p>
              Premium pilot trousers and uniform essentials engineered for
              long-haul comfort, durability, and cockpit professionalism.
            </p>
          ...
          />
          <Image
            src="/images/pward/Goshawk-womens-regular-black-WORB__33465-removebg-preview.png"
            alt="pilot uniform"
