// components/PilotWardrobeNav.tsx
"use client";
...
const PilotWardrobeNav = () => {
  ...
  // Homepage specific navigation items (different from main header)
  const homeMenuItems = [
   
    { title: "Uniforms", path: "/shop/uniforms" },
    { title: "Headsets", path: "/shop/headsets" },
        ...
        >
          ...
          <div className="xl:w-auto flex-col sm:flex-row w-full flex sm:justify-between sm:items-center gap-5 sm:gap-10">
            <Link className="flex-shrink-0" href="/">
              {/* Different logo for homepage */}
              <Image
                src="/images/logo/logopi.png"
                alt="PilotWardrobe Home"
                width={180}
                height={48}
                ...
                <div className="flex items-center">
                  ...
                  <div className="relative max-w-[333px] sm:min-w-[333px] w-full">
                    ...
                    <input
                      ...
                      value={searchQuery}
                      type="search"
                      placeholder="Search headsets, uniforms, and accesories..."
                      autoComplete="off"
...
export default PilotWardrobeNav;