...
//   // Aviation-specific categories
//   const options = [
//     { label: "All Categories", value: "0" },
//     { label: "Pilot Uniforms", value: "uniforms" },
//     { label: "Epaulettes & Wings", value: "epaulettes" },
...
//                     <button
//                       aria-label="Search"
//                       className="absolute right-3 top-1/2 -translate-y-1/2 hover:text-blue transition"
//                     >
//                       <svg
...
//           {/* Right: Support + Account + Cart */}
//           <div className="flex w-full lg:w-auto items-center justify-between lg:justify-end gap-7.5">
...
//               <button onClick={handleOpenCartModal} className="flex items-center gap-2.5 relative">
//                 <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
//               >
//                 {/* Your existing hamburger SVG code */}
...
//             <nav>
//               <ul className="flex flex-wrap items-center gap-6 lg:gap-10 py-4 text-custom-sm font-medium">
//                 <li><Link href="/shop-without-sidebar" className="text-dark hover:text-blue">Shop</Link></li>
//                 <li><Link href="/SwapExchange" className="text-dark hover:text-blue">Swap</Link></li>
//                  <li><Link href="/about" className="text-blue font-semibold">About</Link></li>
//                 <li><Link href="/sell" className="text-blue font-semibold">Sell Your Gear</Link></li>
//                 <li><Link href="/blog" className="text-dark hover:text-blue">Blog</Link></li>
//                 <li><Link href="/contact" className="text-dark hover:text-blue">Contact</Link></li>
//               </ul>
//             </nav>
//           </div>
//         </div>
